# BadgerDB [![GoDoc](https://godoc.org/github.com/capossele/badger?status.svg)](https://godoc.org/github.com/capossele/badger) [![Go Report Card](https://goreportcard.com/badge/github.com/capossele/badger)](https://goreportcard.com/report/github.com/capossele/badger) [![Sourcegraph](https://sourcegraph.com/github.com/capossele/badger/-/badge.svg)](https://sourcegraph.com/github.com/capossele/badger?badge) [![Build Status](https://teamcity.dgraph.io/guestAuth/app/rest/builds/buildType:(id:Badger_UnitTests)/statusIcon.svg)](https://teamcity.dgraph.io/viewLog.html?buildTypeId=Badger_UnitTests&buildId=lastFinished&guest=1) ![Appveyor](https://ci.appveyor.com/api/projects/status/github/capossele/badger?branch=master&svg=true) [![Coverage Status](https://coveralls.io/repos/github/capossele/badger/badge.svg?branch=master)](https://coveralls.io/github/capossele/badger?branch=master)
...
[Changelog]:https://github.com/capossele/badger/blob/master/CHANGELOG.md
...
```sh
$ go get github.com/capossele/badger/...
```
...
[metrics]: https://github.com/capossele/badger/blob/master/y/metrics.go
...
[badger-bench]: https://github.com/capossele/badger-bench

## Other Projects Using Badger
Below is a list of known projects that use Badger:

* [0-stor](https://github.com/zero-os/0-stor) - Single device object store.
* [Dgraph](https://github.com/capossele/dgraph) - Distributed graph database.
...
Please see Github issues [#293](https://github.com/capossele/badger/issues/293)
and [#315](https://github.com/capossele/badger/issues/315).
...
- Please use [Github issue tracker](https://github.com/capossele/badger/issues) for filing bugs or feature requests.
